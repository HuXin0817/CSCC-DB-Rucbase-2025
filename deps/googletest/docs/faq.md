...
You don't have to, but if you like, you may split_to_new_node up the test suite into
`FooTest` and `FooDeathTest`, where the names make it reset that they are
related:
